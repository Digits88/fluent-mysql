...
/*
    ...
    @param client {mysql.client} An instance retrieved from `mysql.createClient`.
 */
var QueryBuilder = function(client) {
    ...
    /*
        ...
        @param cb {Function} Callback - See node-mysql for signature.
     */
    ...
    this.where = function(field, value, operator) {
        this.conditions.push(new this.condition(field, value, operator));
    };
...
/*
    ...
    Insert statements.
 */
var InsertBuilder = function(client, tableName) {
 ...
 */
var MultiInsertBuilder = function(client, tableName) {
...
/*
    ...
    Insert statements.
 */
var UpdateBuilder = function(client, tableName) {
    this.builder = new QueryBuilder(client);
    this.tableName = tableName;
...
var SelectBuilder = function(client, tableName) {
    this.builder = new QueryBuilder(client);
    this.tableName = tableName;
...
var DeleteBuilder = function(client, tableName) {
    this.builder = new QueryBuilder(client);
    this.tableName = tableName;
...
module.exports = Db = function(connOpts) {
    ...
    /*
        Lazily initialized sql client object.
     */
    this.client = function() {
        if (!self._mysqlClient) {
            self._mysqlClient = mysql.createClient(connOpts);
        }
    ...
    this.update = function(tableName) {
        return new UpdateBuilder(this.client(), tableName);
    };
    ...
    this.insertInto = function(tableName) {
        return new InsertBuilder(this.client(), tableName);
    };
    ...
    this.insertMultipleRowsInto = function(tableName) {
        return new MultiInsertBuilder(this.client(), tableName);
    };

    this.selectFrom = function(tableName) {
        return new SelectBuilder(this.client(), tableName);
    };

    this.deleteFrom = function(tableName) {
        return new DeleteBuilder(this.client(), tableName);
    };
